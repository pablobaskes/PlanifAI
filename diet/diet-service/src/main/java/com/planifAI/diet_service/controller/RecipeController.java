...
public class RecipeController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<RecipeDTO> findById(@PathVariable("id") UUID id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<RecipeDTO> update(@PathVariable("id") UUID id, @RequestBody RecipeDTO dto) {
